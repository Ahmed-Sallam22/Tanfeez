    ...
    <div>
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <button
          ...
          className="px-4 flex items-center gap-2 py-2 bg-[var(--color-primary)] text-white rounded-md hover:bg-blue-700 transition-colors"
        >
        ...
        >
          ...
          <div className="flex justify-end gap-3 pt-4">
            ...
            <button
              ...
              className="px-4 py-2 text-sm font-medium text-white bg-[var(--color-primary)] border border-[var(--color-primary)] rounded-md hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-[var(--color-primary)]"
            >
              {primaryBtnText}
            </button>
          </div>
