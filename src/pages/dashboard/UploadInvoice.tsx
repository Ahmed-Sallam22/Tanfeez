      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 text-[var(--color-primary)] hover:text-[var(--color-primary-hover)] transition-colors"
          >
      ...
      <div className="bg-white rounded-2xl shadow-sm ring-1 ring-black/5 p-6">
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <div>
              <p className="text-lg font-medium text-gray-900">
                ...
                <span className="text-[var(--color-primary)]">{t("invoice.browse")}</span>
              </p>
        ...
        <div className="flex justify-end gap-3 pt-6">
          ...
          <button
            ...
            className="px-6 py-2.5 text-sm font-medium text-white bg-[var(--color-primary)] hover:bg-[var(--color-primary-hover)] rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
          >
            {isUploading ? (
              <>
