...
export default function ReservationsDetails() {
  ...
  // Get status from navigation state (passed from Reservations page)
  const transferStatus = location.state?.status || null;

  // Use RTK Query to fetch transfer details - HFR code for reservations
