...
export default function PendingReservations() {
  ...
  const getPendingTransferColumns = (): TableColumn[] => {
    const cols: TableColumn[] = [
      {
        id: "code",
        header: t("pendingReservations.transactionCode"),
        accessor: "code",
        width: 160,
        minWidth: 140,
        sortable: true,
      ...
      {
        id: "requested_by",
        header: t("pendingReservations.requestedBy"),
      ...
      {
        id: "transaction_date",
        header: t("pendingReservations.transactionDate"),
      ...
      {
        id: "amount",
        header: t("pendingReservations.amount"),
        accessor: "amount",
        width: 120,
        minWidth: 100,
        sortable: true,
  ...
  return (
    <div>
      <div className="flex justify-between items-center">
        ...
        {!isDelegateMode ? (
          ...
          >
            ...
            {t("pendingReservations.delegate")}
          </button>
        ) : (
          <div className="flex items-center gap-2">
            ...
            >
              {t("pendingReservations.cancelDelegate")}
            </button>
            <button
            ...
            >
              {t("pendingReservations.proceedToDelegate")}
            </button>
          </div>
        )}
      </div>
      ...
      <div className="p-4 bg-white rounded-2xl mt-4">
        <div className="flex items-center gap-4">
          <div className="flex-1">
            <SearchBar
              placeholder={t("pendingReservations.searchPlaceholder")}
              value={searchQuery}
            ...
            <div className="flex items-center gap-2">
              <label className="flex items-center gap-2 text-sm text-gray-600">
                <input
                  ...
                  className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500"
                />
                {t("pendingReservations.selectAll")}
              </label>
            </div>
          )}
        </div>
        ...
        {isLoading ? (
          <div className="flex justify-center items-center h-64 bg-white rounded-lg">
            ...
            <span className="ml-2 text-gray-600">
              {t("pendingReservations.loadingTransfers")}
            </span>
          </div>
        ) : (
          <SharedTable
            title={t("pendingReservations.recentpendingReservations")}
            columns={getPendingTransferColumns()}
            data={tableData}
            onFilter={handleFilter}
            filterLabel={t("pendingReservations.filterpendingReservations")}
            maxHeight="600px"
            className="shadow-lg"
            showPagination={true}
      ...
      <SharedModal
        ...
        title={t("pendingReservations.approveBudgetRequest")}
        size="md"
      >
        <div className="p-4">
          <div className="flex items-center gap-3 mb-4">
            <p className="text-sm text-[#282828]">
              {t("pendingReservations.approveMessage")}
            </p>
          </div>

          <div>
            <label className="block text-xs font-bold text-[#282828] mb-2">
              {t("pendingReservations.reasonOptional")}
            </label>
            <textarea
              rows={7}
              value={reason}
      ...
      <SharedModal
        ...
        title={t("pendingReservations.rejectTransfer")}
        size="md"
      >
        <div className="p-4">
          <div className="flex items-center gap-3 mb-4">
            <div>
              <p className="text-sm text-[#282828]">
                {t("pendingReservations.rejectMessage")}
              </p>
            </div>
          </div>
          ...
          <div>
            <label className="block text-xs font-bold text-[#282828] mb-2">
              {t("pendingReservations.reasonForRejectionOptional")}
            </label>
            <textarea
              rows={7}
              value={reason}
          ...
          <div className="flex justify-end gap-3">
            ...
            >
              {t("pendingReservations.rejectTransferButton")}
            </button>
          </div>
        </div>
      </SharedModal>
      ...
      <SharedModal
        ...
        title={t("pendingReservations.delegateTransfers")}
        size="md"
      >
        <div className="p-4">
          <div className="mb-4">
            <p className="text-sm text-[#282828] mb-4">
              {t("pendingReservations.delegateMessage", {
          ...
          <div className="space-y-4">
            ...
            <div>
              <SharedSelect
                title={t("pendingReservations.selectUser")}
                required={true}
                ...
                placeholder={t("pendingReservations.chooseUserToDelegate")}
                options={userOptions}
              />
            </div>
            ...
            <div>
              <label className="block text-sm font-bold text-[#282828] mb-2">
                {t("pendingReservations.reasonForDelegation")}
              </label>
              <textarea
                rows={5}
          ...
          <div className="flex justify-end gap-3 mt-6">
            ...
            >
              {t("pendingReservations.confirmDelegation")}
            </button>
          </div>
        </div>
      </SharedModal>
